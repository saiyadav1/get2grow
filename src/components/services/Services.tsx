...
const servicesData = [
  {
    ...
    description:
      "We manage your content so your brand stays visible, relevant, and trusted.",
    features: [
      "Content strategy",
      "Reels & graphics",
  ...
  },
  {
    ...
    description:
      "We run conversion-focused ad campaigns that bring qualified leads and sales.",
    features: [
      "Meta Ads",
      "Google Ads",
      "Retargeting",
  ...
  },
  {
    ...
    title: "Branding",
    description:
      "We position your business to look premium, trustworthy, and memorable.",
    features: [
  ...
  },
  {
    ...
    description:
      "We build websites and landing pages designed to convert traffic into customers.",
    features: [
      "Landing pages",
      "Sales funnels",
      "Website copy",
  ...
  },
  {
    ...
    title: "SEO",
    description:
      "We optimize your search visibility to drive organic growth and capture high-intent customers.",
    features: [
      "Keyword Research",
      "Competitor Research",
      "On-Page SEO",
  ...
  },
  {
    ...
    description:
      "We shape new brands from ground up, crafting compelling identities that build instant trust.",
    features: [
      "Logo design",
      "Visual identity",
      "Brand guidelines",
            ...
            <div className="w-1/2 flex items-center justify-center relative">
              ...
              >
                ...
                >
                  ...
                  <span className="text-[9px] font-bold text-[#22c55e] uppercase tracking-[0.3em] mt-1">
                    Phase
                  </span>
                  ...
                  {servicesData.map((_, i) => {
                    ...
                    return (
                      <motion.line
                        ...
                        initial={{ opacity: 0 }}
                        animate={{
                          opacity: isRevealed ? (isActive ? 0.8 : 0.08) : 0,
                        }}
                        transition={{
                          duration: 0.5,
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{
                        ...
                        rotate: activeIndex * -60, // counter rotate so icons stay upright
                        x,
                        y,
                      }}
                      transition={{
                      ...
                      className={`absolute w-16 h-16 rounded-full flex items-center justify-center backdrop-blur-xl transition-all duration-500 ${
                        isActive
                    ...
                    >
                      <service.icon
                        className={`w-7 h-7 transition-colors duration-500 ${isActive ? "text-[#1a1a1a]" : "text-gray-400"}`}
                      />
                    </motion.div>
                  );
                })}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-[#22c55e] uppercase tracking-[0.2em]">
                      0{activeIndex + 1} / Expertise
                    </span>
                  </motion.div>
                  <motion.h3
                    variants={childVariants}
                    className="text-5xl xl:text-6xl font-semibold mb-6 text-[#f9f8f6] tracking-tight"
                  >
